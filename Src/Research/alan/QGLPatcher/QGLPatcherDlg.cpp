...
#define PATCHER_COMPANY_OFFICIAL_WEBSITE		_T("http://www.gameone.com")
#define PATCHER_QGL_OFFICIAL_WEBSITE			_T("http://qlo.gameone.com.cn/")
#define PATCHER_QGL_POINT_WEBSITE				_T("http://qlo.gameone.com.cn/news.php?to=2")
#define PATCHER_QGL_ACCOUNT_WEBSITE				_T("http://qlo.gameone.com.cn/bbs/")
#define PATCHER_QGL_REGISTRATION_WEBSITE		_T("http://qlo.gameone.com.cn/news.php?to=1")
#define PATCHER_QGL_PATCH_WEBSITE				_T("http://qlo.gameone.com.cn/down.htm")

#define PATCHER_WEBBROWSER1_OFFSET_X			31
#define PATCHER_WEBBROWSER1_OFFSET_Y			80
#define PATCHER_WEBBROWSER1_WIDTH				233
...
void CQGLPatcherDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_EXPLORER_LOWER, m_browser2);
...
BOOL CQGLPatcherDlg::OnInitDialog()
{
	...
	SetWindowPos(&CWnd::wndTopMost, 0, 0, PATCHER_WINDOW_SIZE_WIDTH, PATCHER_WINDOW_SIZE_HEIGHT, SWP_SHOWWINDOW);
	...
	m_browser2.Navigate(PATCHER_QGL_ACCOUNT_WEBSITE,NULL,NULL,NULL,NULL);
	m_browser2.SetWindowPos(GetWindow(0), PATCHER_WEBBROWSER2_OFFSET_X, PATCHER_WEBBROWSER2_OFFSET_Y, PATCHER_WEBBROWSER2_WIDTH, PATCHER_WEBBROWSER2_HEIGHT, 0);
...
void CQGLPatcherDlg::HidePage(unsigned int pageno)
{
	...
	case PATCHER_PAGE1:
		...
		::ShowWindow(GetDlgItem(IDC_EXPLORER_LOWER)->GetSafeHwnd(), SW_HIDE);
...
void CQGLPatcherDlg::ShowPage(unsigned int pageno)
{
	...
	case PATCHER_PAGE1:
		...
		::ShowWindow(GetDlgItem(IDC_EXPLORER_LOWER)->GetSafeHwnd(), SW_SHOW);
