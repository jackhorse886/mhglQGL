...
#define DEFAULT_TRACKER_IP						_T("192.100.100.228")
...
private:
	...
	BOOL RecursiveMoveUnlessPatcher(CONST String SrcFolder, CONST String TargetFolder);
...
private:
	...
	DownloadMethod			SelectPatchProtocol();
