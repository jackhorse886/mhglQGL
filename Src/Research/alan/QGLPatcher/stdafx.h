...
#define WMU_FINISHEDCHECKFILE		WM_APP + 6
#define	WMU_RECHECKFILE				WM_APP + 7
#define	WMU_STARTCHECKFILE			WM_APP + 8
#define	WMU_STARTDEOCDEFILE			WM_APP + 9
#define	WMU_FINISHDECODEFILE		WM_APP + 10
#define	WMU_STOPDECODEFILE			WM_APP + 11
#define	WMU_EXITPROGRAM				WM_APP + 12
